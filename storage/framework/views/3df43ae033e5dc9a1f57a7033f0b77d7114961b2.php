    ...
    <div class="row">
      ...
      <div class="col-md-3">
        <div class="box box-danger">
          <div class="box-header with-border">
            <h3 class="box-title"><?php echo __('Payment For: '); ?><strong><?php echo date("F Y", strtotime($salary_month)); ?></strong>
            </h3>
          </div>
          <!-- /.box-header -->
          <div class="box-body">
            <form action="<?php echo url('/hrm/salary-payments/store'); ?>" method="post">
              ...
              <div class="form-group<?php echo $errors->has('payment_amount') ? ' has-error' : ''; ?>">
                ...
                <input type="text" name="payment_amount" value="<?php echo old('payment_amount'); ?>" class="form-control"
                  id="payment_amount">
              ...
              <div class="form-group<?php echo $errors->has('note') ? ' has-error' : ''; ?>">
                ...
                <textarea name="note" class="form-control" id="note" rows="3"
                  placeholder="<?php echo __('Enter note..'); ?>"></textarea>
      ...
      <div class="col-md-9">
        <div class="box box-primary">
          <div class="box-header with-border">
            <h3 class="box-title"><?php echo __('Payment Details For:'); ?>

              <strong><?php echo date("F Y", strtotime($salary_month)); ?></strong></h3>
          </div>
          <!-- /.box-header -->
          <div class="box-body">
