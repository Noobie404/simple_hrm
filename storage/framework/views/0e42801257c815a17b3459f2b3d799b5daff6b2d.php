                                ...
                                <div class="input-group margin">
                                    ...
                                    <span class="input-group-btn">
                                        <button type="submit" class="btn btn-info btn-flat"><i
                                                class="icon fa fa-arrow-right"></i> <?php echo __('Go'); ?></button>
                                    </span>
                                </div>
                            </div>
                        </div>
                    ...
                    <table class="table table-bordered table-striped">
                        <thead>
                            <tr>
                                ...
                                <?php for($i=1; $i<=$number_of_days; $i++): ?> <th class="text-center"><?php echo $i; ?></th>
                                    <?php endfor; ?>
                            </tr>
                        </thead>
                        <tbody>
                            ...
                            <tr>
                                <td><a
                                        href="<?php echo url('/people/employees/details/' . $employee['id']); ?>"><?php echo $employee['name']; ?></a>
                                </td>
                                <?php for($i = 1; $i <= $number_of_days; $i++): ?> <td class="text-center">
                                    <?php if($i>=1 AND $i<=9): ?> <?php ($day=$date."-0".$i); ?> <?php else: ?> <?php ($day=$date."-".$i); ?> <?php endif; ?>
                                        ...
                                        data-original-title="<?php echo $monthly_holiday['holiday_name']; ?>">
                                        <?php echo __('H'); ?></span>
                                        <?php endif; ?>
                                        ...
                                        <span class="btn btn-xs btn-danger btn-flat" data-toggle="tooltip"
                                            data-original-title="Weekly Holiday"><?php echo __('H'); ?></span>
                                        <?php endif; ?>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                        ...
                                        <span class="btn btn-xs btn-success btn-flat" data-toggle="tooltip"
                                            data-original-title="Present"> <?php echo __('P'); ?> </span>
                                        <?php endif; ?>
                                        ...
                                        <span class="btn btn-xs btn-warning btn-flat" data-toggle="tooltip"
                                            data-original-title="Absence"><?php echo __('A'); ?></span>
                                        <?php else: ?>
                                        <span class="btn btn-xs btn-info btn-flat" data-toggle="tooltip"
                                            data-original-title="<?php echo $attendance['leave_category']; ?>"><?php echo __('L'); ?></span>
                                        <?php endif; ?>
